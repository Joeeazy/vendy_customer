...
describe('search URL state', () => {
  it('round-trips through the URL', () => {
    const query =
      'service=plumbing-leak-repair&area=kilimani&sort=jobs_completed&min_jobs=10&max_price=5000&max_distance=5000';
  ...
  it('keeps the default sort out of the URL', () => {
    expect(serializeSearch(parseSearch(new URLSearchParams('service=blocked-drain&sort=distance')))).toBe(
